...
import { ExternalLink, GitBranch, AlertCircle, Folder } from "lucide-react";
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      {techTags.map((tag) => (
                        <span
                          key={tag}
                          className="inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-medium text-accent-cyan bg-accent-cyan/5 border border-accent-cyan/15 hover:border-accent-cyan/40 hover:bg-accent-cyan/10 hover:shadow-[0_0_10px_rgba(34,200,255,0.15)] transition-all duration-300 cursor-default"
                        >
                          {tag}
                        </span>
                      ))}
                      ...
                      <div className="flex items-center gap-3 pt-3 border-t border-white/5">
                        {project.live_url && (
                          <a
                            ...
                            className="inline-flex items-center gap-1.5 text-xs font-medium text-text-secondary hover:text-accent-cyan transition-colors duration-300 group/link"
                          >
